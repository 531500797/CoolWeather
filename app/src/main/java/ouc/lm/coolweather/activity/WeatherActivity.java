...
import ouc.lm.coolweather.receiver.AutoUpdateReceiver;
import ouc.lm.coolweather.service.AutoUpdateService;
...
/**
 * Created by Lavida on 2016-04-18.
 */
public class WeatherActivity extends Activity implements View.OnClickListener {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                if ("countyCode".equals(type)) {
                    ...
                    //处理服务器返回的天气信息
                    Utility.handleWeatherResponse(WeatherActivity.this, response);       //解析服务器返回的JSON数据，并将解析出的数据存储到本地
    ...
    //从SharedPreferences文件中读取存储天气信息，并显示到界面上
